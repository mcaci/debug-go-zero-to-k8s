...
func Create(l, h int, text, filePath, bgColorHex, fgColorHex, figlet, fontPath string, fontSize, xPtFactor, yPtFactor float64, delay int, banner, blink, alt bool) {
	outPath := filePath
	if filePath == "" {
...
func makeBanner(asciiArtLines []string, l, h int, bgColorHex, fgColorHex, fontPath string, fontSize, xPtFactor, yPtFactor float64) []*image.Paletted {
...
func makeBlink(asciiArtLines []string, l, h int, bgColorHex, fgColorHex, fontPath string, fontSize, xPtFactor, yPtFactor float64) []*image.Paletted {
	const nFrames = 10
	var images []*image.Paletted
	for i := 0; i < nFrames; i++ {
...
func makeAlt(asciiArtLines []string, l, h int, bgColorHex, fgColorHex, fontPath string, fontSize, xPtFactor, yPtFactor float64) []*image.Paletted {
	const nFrames = 10
	var images []*image.Paletted
	for i := 0; i < nFrames; i++ {
...
func makePng(asciiArtLines []string, l, h int, bgColorHex, fgColorHex, fontPath string, fontSize, xPtFactor, yPtFactor float64) *image.Paletted {
	img, err := setupBG(bgColorHex, l, h)
	if err != nil {
		log.Fatal(err)
	}
